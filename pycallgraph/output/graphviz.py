...
class GraphvizOutput(Output):
    ...
    def prepare_graph_attributes(self):
        generated_message = '\\n'.join([f'Generated by Python Call Graph v{__version__}','http://pycallgraph.slowchop.com'])
    ...
    def done(self):
        ...
        try:
            ...
            pass
            # os.unlink(temp_name) # zhangxingjun
    ...
    def edge(self, edge, attr):
        return '"{0.src_func}" -> "{0.dst_func}" [{1}];'.format(edge, self.attrs_from_dict(attr))
